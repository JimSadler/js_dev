                    ...
                    <!-- <div class="isotope"> -->
                        <b-col cols="4" class="col-sm-4 portfolio-item web">
                            <a class="portfolio-link" role="button" v-b-modal.modal-scrollable1>
                                ...
                                <img src="~assets/img/portfolio/JSGscreen.jpg" class="img-centered" alt="">
                            </a>
                        ...
                        <b-col cols="4" class="col-sm-4 portfolio-item web design">
                            <a class="portfolio-link" role="button" v-b-modal.modal-scrollable2>
                                <div class="caption">
                                    <div class="caption-content">
                                        <h3>Martha Burgess Novak
                                        </h3>
                                        <p>Web Design/Development</p>

                                    </div>
                                </div>
                                <img src="~assets/img/portfolio/BurgessProcessLink.jpg" class="img-centered" alt="">
                            </a>
                        ...
                        <b-col cols="4" class="col-sm-4 portfolio-item web">
                            <a class="portfolio-link" role="button" v-b-modal.modal-scrollable4>
                                ...
                                <img src="~assets/img/portfolio/DV_site1.png" class="img-centered" alt="">
                            </a>
                        ...
                        <b-col class="col-sm-4 portfolio-item web">
                            <a class="portfolio-link" role="button" v-b-modal.modal-scrollable5>
                                <div class="caption">
                                    <div class="caption-content">
                                        <h3>Angry Apples Marketing
                                        </h3>
                                        <p>Web Development</p>

                                    </div>
                                </div>
                                <img src="~assets/img/portfolio/AApples2.png" class="img-centered" alt="">
                            </a>
                        ...
                        <b-col class="col-sm-4 portfolio-item web design">
                            <a class="portfolio-link" role="button" v-b-modal.modal-scrollable6>
                                <div class="caption">
                                    <div class="caption-content">
                                        <h3>Benevolent Healing 
                                        </h3>
                                        <p>Web Development/Design</p>

                                    </div>
                                </div>
                                <img src="~assets/img/portfolio/BH1.png" class="img-centered" alt="">
                            </a>
                        ...
                        <b-col class="col-sm-4 portfolio-item web">
                            <a class="portfolio-link" role="button" v-b-modal.modal-scrollable7>
                                ...
                                <img src="~assets/img/portfolio/AEYE1.png" class="img-centered" alt="">
                            </a>
...
<!--                       
                        ...
                        <b-col class="col-sm-4 portfolio-item design">
                            <a href="./port_pages/adoptly.html" target="_blank" class="portfolio-link">
                                <div class="caption">
                                    <div class="caption-content">
                                        <h3>Adoptly Project
                                        </h3>
...
import modal4a from '~/components/Modals/Modal4a.vue'
import modal5a from '~/components/Modals/Modal5a.vue'
...
h1,h2,h3,h4,h5,h6 {
    font-family: 'NoirPro-SemiBold', Fallback,
    sans-serif;
}
...
.modal_Descrip, .modal_Details {
    margin-left: 2%;
    margin-top: 1%;
}
/* h1,h2,h3,h4,h5,h6 {
    font-family: 'proximanova-light-webfont', Fallback,
    sans-serif;
} */
.modal_Descrip h3, .modal_Details h3 {
    font-family: 'proximanova-light-webfont', Fallback,
...
.page-title {
    font-family: 'proximanova-semi' , Fallback, sans-serif;
}
p {
    font-family: 'proximanova-light-webfont', Fallback, sans-serif;
}
li {
    font-family: 'proximanova-light-webfont', Fallback, sans-serif;
}
